...
import { Mail, Github, Phone, ArrowRight, Code, Cpu, Smartphone, Eye, Award, Briefcase, GraduationCap } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute -left-24 top-10 h-96 w-96 rounded-full bg-gradient-to-br from-amber-500/20 via-orange-400/15 to-transparent blur-[120px]" />
        <div className="absolute right-0 top-1/4 h-96 w-96 rounded-full bg-gradient-to-br from-blue-500/15 via-purple-400/10 to-transparent blur-[140px]" />
        <div className="absolute left-1/2 bottom-0 h-96 w-96 rounded-full bg-gradient-to-t from-cyan-400/10 to-transparent blur-[120px]" />
      </div>
      ...
      <nav className="sticky top-0 z-50 bg-zinc-950/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link
            to="/"
            className="text-2xl font-bold bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent hover:brightness-110"
          >
            ← Home
          </Link>
      ...
      {/* Hero Section */}
      <section id="home" className="relative pt-20 pb-16 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <a
              href="mailto:kurukuladithyapraveena@gmail.com"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-400 to-orange-500 text-black px-8 py-4 rounded-full font-semibold hover:shadow-2xl hover:shadow-amber-500/40 transition-all group mt-6"
            >
      ...
      {/* About Me Section */}
      <section id="about" className="relative py-20 px-6 bg-zinc-900/30">
      ...
      {/* Projects Section */}
      <section id="portfolio" className="py-20 px-6 bg-zinc-900/30">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center justify-between gap-6 mb-12">
            ...
            <div className="flex flex-wrap gap-3">
              <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm text-white/80">UI + UX</span>
              <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm text-white/80">System design</span>
              <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm text-white/80">Data integrations</span>
            </div>
          </div>
      ...
      <footer className="py-8 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto text-center text-white/40 text-sm">
          <p>© 2025 {personalInfo.name}. Building thoughtful technology.</p>
        </div>
      </footer>
    </div>
  );
